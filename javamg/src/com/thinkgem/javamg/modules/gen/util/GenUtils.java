 ...
 * 
 */
package com.thinkgem.javamg.modules.gen.util;
...
import com.thinkgem.javamg.common.mapper.JaxbMapper;
import com.thinkgem.javamg.common.utils.DateUtils;
import com.thinkgem.javamg.common.utils.FileUtils;
import com.thinkgem.javamg.common.utils.FreeMarkers;
import com.thinkgem.javamg.common.utils.StringUtils;
import com.thinkgem.javamg.modules.gen.entity.GenCategory;
import com.thinkgem.javamg.modules.gen.entity.GenConfig;
...
import com.thinkgem.javamg.modules.gen.entity.GenTemplate;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		String[] functionNameSimple = genScheme.getFunctionNameSimple().split(":");
		model.put("functionNameSimple", functionNameSimple[0]);
		
		if (functionNameSimple.length > 1) {
			model.put("LOG_OPERATION", functionNameSimple[1]);
		} else {
			model.put("LOG_OPERATION", "");
		}
		
		if (functionNameSimple.length > 2) {
			model.put("LOG_OPERATIONTYPE", functionNameSimple[2]);
		} else {
			model.put("LOG_OPERATIONTYPE", "");
		}
